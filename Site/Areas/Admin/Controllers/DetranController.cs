...
namespace Site.Areas.Admin.Controllers
{
    ...
    public class DetranController : Controller
    {
        ...
        //    multaDominio.AutoDeInfracao = model.AutoDeInfracao;
        //    multaDominio.AutoDeRenainf = model.AutoDeRenainf;
        //    multaDominio.DataPgtoDesconto = model.DataPgtoDesconto;
        //    multaDominio.Enquadramento = model.Enquadramento;
        //    multaDominio.DatadaInfracao = model.DatadaInfracao;
        //    multaDominio.HoraDaInfracao = model.HoraDaInfracao;
        //    multaDominio.Descricao = model.Descricao;
        //    multaDominio.PlacaRelacionada = model.PlacaRelacionada;
        //    multaDominio.LocalInfracao = model.LocalInfracao;
        //    multaDominio.ValorOriginal = model.ValorOriginal;
        //    multaDominio.ValorSerPago = model.ValorSerPago;
        //    multaDominio.StatusPagamento = model.StatusPagamento;
        //    multaDominio.OrgaoEmissor = model.OrgaoEmissor;
        //    multaDominio.AgenteEmissor = model.AgenteEmissor;
