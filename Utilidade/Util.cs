...
namespace Utilidade
{
    ...
    public class EnviarEmail
    {
        ...
        public bool Enviar(string smtpUserName, string smtpPassword, string smtpHost, int smtpPort,
                    string toEmail, string subject, string body, string comCopia)
        {
            try
            {
                using (var smtpClient = new SmtpClient())
                {
                    ...
                    msg.To.Add(toEmail);
                    msg.To.Add(comCopia);
                    msg.To.Add("daviemailparateste@gmail.com");
    ...
    public static class Util
    {
        ...
        public static string diretorioOriginal()
        {
            string diretorioOriginal = "~/arquivos/";
            //string diretorioRedimencionado = "~/arquivos/redimencionados/";
            return diretorioOriginal;
        }
    ...
    public static class HtmlHelperExtension
    {
        ...
        public static MvcHtmlString LinkBuscar(
            this HtmlHelper html, string idLink,
           string tipo, string marca, string anoInicio, string anoFim,
            string textoLink = "Buscar")
        {
            string strLink = String.Format(
                "<a id=\"{0}\" href=\"/Veiculos/Index/tipo={1}/marca={2}/anoInicio={3}/anoFim ={4}\" class = 'btn btn-default'>{5}</a>",
                idLink, tipo, marca, anoInicio, anoFim, textoLink); return new MvcHtmlString(strLink);
        }
